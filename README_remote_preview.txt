...
- `settings.json` ΓÇö sanitized Windows Terminal configuration harvested by `tool.exporter`.
- `zshrc.portable` ΓÇö cleaned `.zshrc` produced by `tool.sanitizer`.
- `manifest.json` ΓÇö authoritative list of shipped files and SHA-256 checksums.
- `assets/` ΓÇö icons and images copied from local references.
- `fonts/` ΓÇö optional Nerd Fonts bundled for offline use.
